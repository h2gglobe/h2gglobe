				 ...
				 BaseGenLevelSmearer *genSys, BaseSmearer *phoSys, BaseDiPhotonSmearer * diPhoSys)
{
	...
	myVBFSpin_DeltaPhiJJ = jet1.DeltaPhi(jet2);
	...
	myVBFSpin_CosThetaJ1 = leadingBoosted.Angle(jet1Boosted.Vect());
	myVBFSpin_CosThetaJ2 = leadingBoosted.Angle(jet2Boosted.Vect());
