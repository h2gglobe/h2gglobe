			 ...
			 string outputdir = "./")
{
  ...
  for ( int ifile = 0; ifile < 2 ; ifile++ ){
	...
	//eff plots
	sprintf(hname,"efficiency/hEff_vs_JetPt_bkgSub_%s_%s", suffId[iid].c_str(), suffLevel[ilevel].c_str());
	...
	hEff_vs_JetPt[ifile][iid][ilevel] ->Rebin(rebinPt);
 	...
 	sprintf(hname,"efficiency/hEff_vs_JetEta_bkgSub_%s_%s", suffId[iid].c_str(), suffLevel[ilevel].c_str());
	...
	hEff_vs_JetEta[ifile][iid][ilevel] ->Rebin(rebinEta);
 	...
 	sprintf(hname,"efficiency/hEff_vs_NumberOfVertices_bkgSub_%s_%s", suffId[iid].c_str(), suffLevel[ilevel].c_str());
