...
public:
 ...
 private:
  ...
  float & singlelegsigma1Pix_;
  float & singlelegsigma1Tib_;
  float & singlelegsigma1Tob_;
  float & singlelegsigma1PixFwd_;
  float & singlelegsigma1Tid_;
  float & singlelegsigma1Tec_;
