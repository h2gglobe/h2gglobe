...
Float_t correctedpfMET[MAX_DIPHOTONS];
Float_t correctedpfMET_phi[MAX_DIPHOTONS];

Float_t shiftscaleMET_eta[MAX_DIPHOTONS];
Float_t shiftscaleMET_e[MAX_DIPHOTONS];
