...
void idmva_interp() {
  ...
  */
  ...
  phoidMva_EB_up_DYJetsToLL = (TH1*)pho1_phoidMva_EB_cat0_DYJetsToLL_top->Clone();
  phoidMva_EB_up_DYJetsToLL->Add(pho2_phoidMva_EB_cat0_DYJetsToLL_top);
  phoidMva_EE_up_DYJetsToLL = (TH1*)pho1_phoidMva_EE_cat0_DYJetsToLL_top->Clone();
  phoidMva_EE_up_DYJetsToLL->Add(pho2_phoidMva_EE_cat0_DYJetsToLL_top);

  phoidMva_EB_down_DYJetsToLL = (TH1*)pho1_phoidMva_EB_cat0_DYJetsToLL_bottom->Clone();
  phoidMva_EB_down_DYJetsToLL->Add(pho2_phoidMva_EB_cat0_DYJetsToLL_bottom);
  phoidMva_EE_down_DYJetsToLL = (TH1*)pho1_phoidMva_EE_cat0_DYJetsToLL_bottom->Clone();
  phoidMva_EE_down_DYJetsToLL->Add(pho2_phoidMva_EE_cat0_DYJetsToLL_bottom);
  ...
  */
  ...
  phoidMva_EB_up_DYJetsToLL->SetMarkerStyle(0);
  phoidMva_EE_up_DYJetsToLL->SetMarkerStyle(0);
