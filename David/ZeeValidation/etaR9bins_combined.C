...
void etaR9bins_combined(TString r9bin, bool lead, bool idmva, bool combined) {
  ...
  for (int i=0; i<8; i++) {
    ...
    iStr+=i;
    if (!idmva) {
      hist_Data[i] = (TH1*)(file->Get("pho"+lead_str+"_sigmaEOverE_"+r9bin+"_cat"+iStr+"_Data"))->Clone();
      hist_MC[i] = (TH1*)(file->Get("pho"+lead_str+"_sigmaEOverE_"+r9bin+"_cat"+iStr+"_DYJetsToLL"))->Clone();
      hist_MC_up[i] = (TH1*)(file->Get("pho"+lead_str+"_sigmaEOverE_"+r9bin+"_up_cat"+iStr+"_DYJetsToLL"))->Clone();
      hist_MC_down[i] = (TH1*)(file->Get("pho"+lead_str+"_sigmaEOverE_"+r9bin+"_down_cat"+iStr+"_DYJetsToLL"))->Clone();
    } else {
      hist_Data[i] = (TH1*)(file->Get("pho"+lead_str+"_phoidMva_"+r9bin+"_cat"+iStr+"_Data"))->Clone();
      hist_MC[i] = (TH1*)(file->Get("pho"+lead_str+"_phoidMva_"+r9bin+"_cat"+iStr+"_DYJetsToLL"))->Clone();
      hist_MC_up[i] = (TH1*)(file->Get("pho"+lead_str+"_phoidMva_"+r9bin+"_up_cat"+iStr+"_DYJetsToLL"))->Clone();
      hist_MC_down[i] = (TH1*)(file->Get("pho"+lead_str+"_phoidMva_"+r9bin+"_down_cat"+iStr+"_DYJetsToLL"))->Clone();
    }
