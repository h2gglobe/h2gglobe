...
void bdtout_etaR9bins_interp(TString r9bin, bool preselNorm=false, bool passcut=false) {
  ...
  for (int i=0; i<4; i++) {
    TString iStr;
    iStr+=i;
    hist_Data[i] = (TH1*)(file_data->Get("bdtout_"+r9bin+"_cat"+iStr+"_Data"))->Clone();
    hist_MC[i] = (TH1*)(file_MC->Get("bdtout_"+r9bin+"_cat"+iStr+"_DYJetsToLL"))->Clone();
    hist_MC_up[i] = (TH1*)(file_MC->Get("bdtout_"+r9bin+"_cat"+iStr+"_DYJetsToLL_top"))->Clone();
    hist_MC_down[i] = (TH1*)(file_MC->Get("bdtout_"+r9bin+"_cat"+iStr+"_DYJetsToLL_bottom"))->Clone();
