void idmvaInputs_EE(bool isEE) {
  ...
  leg->SetFillColor(10);
  leg->SetTextSize(.035);
  leg->AddEntry(pfchargedisogood03_EE_cat0_Data,"Data (12.2fb^{-1})");
  ...
  leg2->AddEntry(pfchargedisogood03_EE_cat0_Data,"Data (12.2fb^{-1})");
  ...
  leg3->SetTextSize(.03);
  leg3->AddEntry(pfchargedisogood03_EE_cat0_Data,"Data (12.2fb^{-1})");
  ...
  leg4->AddEntry(pfchargedisogood03_EE_cat0_Data,"Data (12.2fb^{-1})");
