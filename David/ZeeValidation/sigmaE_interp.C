void sigmaE_interp() {
  ...
  sigmaEOverE_EB_up_DYJetsToLL = (TH1*)pho1_sigmaEOverE_EB_cat0_DYJetsToLL_top->Clone();
  sigmaEOverE_EB_up_DYJetsToLL->Add(pho2_sigmaEOverE_EB_cat0_DYJetsToLL_top);
  sigmaEOverE_EE_up_DYJetsToLL = (TH1*)pho1_sigmaEOverE_EE_cat0_DYJetsToLL_top->Clone();
  sigmaEOverE_EE_up_DYJetsToLL->Add(pho2_sigmaEOverE_EE_cat0_DYJetsToLL_top);

  sigmaEOverE_EB_down_DYJetsToLL = (TH1*)pho1_sigmaEOverE_EB_cat0_DYJetsToLL_bottom->Clone();
  sigmaEOverE_EB_down_DYJetsToLL->Add(pho2_sigmaEOverE_EB_cat0_DYJetsToLL_bottom);
  sigmaEOverE_EE_down_DYJetsToLL = (TH1*)pho1_sigmaEOverE_EE_cat0_DYJetsToLL_bottom->Clone();
  sigmaEOverE_EE_down_DYJetsToLL->Add(pho2_sigmaEOverE_EE_cat0_DYJetsToLL_bottom);
...
//   sigmaEOverE_EE_down_DYJetsToLL->Rebin(2);
  ...
  sigmaEOverE_EB_up_DYJetsToLL->SetMarkerStyle(0);
  sigmaEOverE_EE_up_DYJetsToLL->SetMarkerStyle(0);
  sigmaEOverE_EB_Data->SetMarkerStyle(20);
  sigmaEOverE_EE_Data->SetMarkerStyle(20);
  sigmaEOverE_EB_Data->SetMarkerSize(.6);
  sigmaEOverE_EE_Data->SetMarkerSize(.6);
