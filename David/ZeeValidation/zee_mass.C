void zee_mass() {
  ...
  mass_Data->GetXaxis()->SetRangeUser(60.,119.5);
  mass_Data->Draw("e");
  ...
  mass_ratio->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  sf = mass_cat1_Data->Integral()/mass_cat1_DYJetsToLL->Integral();
  mass_cat1_DYJetsToLL->Scale(sf);

  c_mass_cat->cd(1);
  mass_cat1_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_cat->cd(2);
  mass_cat2_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_cat->cd(3);
  mass_cat3_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_cat->cd(4);
  mass_cat4_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_cat->cd(5);
  mass_cat5_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_cat->cd(6);
  mass_cat6_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  */
  ...
  mass_basecat_cat0_Data->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat0");
  ...
  c_mass_basecat->cd(1);
  mass_basecat_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_basecat_cat0->GetXaxis()->SetRangeUser(60.,119.5);
  mass_ratio_basecat_cat0->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat0");
  mass_ratio_basecat_cat0->Draw("e");
  txt3->DrawLatex(0.35,0.25, "Data/MC ratio");
  line_mass->Draw();

  mass_basecat_cat1_Data->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat1");
  ...
  c_mass_basecat->cd(2);
  mass_basecat_cat1_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_basecat_cat1->GetXaxis()->SetRangeUser(60.,119.5);
  mass_ratio_basecat_cat1->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat1");
  mass_ratio_basecat_cat1->Draw("e");
  txt3->DrawLatex(0.35,0.25, "Data/MC ratio");
  line_mass->Draw();

  mass_basecat_cat2_Data->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat2");
  ...
  c_mass_basecat->cd(3);
  mass_basecat_cat2_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_basecat_cat2->GetXaxis()->SetRangeUser(60.,119.5);
  mass_ratio_basecat_cat2->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat2");
  mass_ratio_basecat_cat2->Draw("e");
  txt3->DrawLatex(0.35,0.25, "Data/MC ratio");
  line_mass->Draw();

  mass_basecat_cat3_Data->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat3");
  ...
  c_mass_basecat->cd(4);
  mass_basecat_cat3_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_basecat_cat3->GetXaxis()->SetRangeUser(60.,119.5);
  mass_ratio_basecat_cat3->GetXaxis()->SetTitle("m_{e^{+}e^{-}}, baseline cat3");
  mass_ratio_basecat_cat3->Draw("e");
  txt3->DrawLatex(0.35,0.25, "Data/MC ratio");
  line_mass->Draw();

  c_mass_basecat->SaveAs("mass_basecat.png");
  ...
  */
  ...
  c_mass_pt->cd(1);
  mass_pt0to20_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_pt0to20_cat0->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_pt->cd(2);
  mass_pt20to40_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_pt20to40_cat0->Sumw2();
  ...
  mass_ratio_pt20to40_cat0->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_pt->cd(3);
  mass_pt40to60_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_pt40to60_cat0->Sumw2();
  ...
  mass_ratio_pt40to60_cat0->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_pt->cd(4);
  mass_pt60to100_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_pt60to100_cat0->Sumw2();
  ...
  mass_ratio_pt60to100_cat0->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  c_mass_pt->cd(5);
  mass_pt100up_cat0_Data->GetXaxis()->SetRangeUser(60.,119.5);
  ...
  mass_ratio_pt100up_cat0->GetXaxis()->SetRangeUser(60.,119.5);
