...
Int_t conv_ntracks[MAX_PHOTONS];
Float_t conv_pairinvmass[MAX_PHOTONS];
Float_t conv_paircotthetasep[MAX_PHOTONS];
Float_t conv_eoverp[MAX_PHOTONS];
Float_t conv_distofminapproach[MAX_PHOTONS];
Float_t conv_dphitrksatvtx[MAX_PHOTONS];
Float_t conv_dphitrksatecal[MAX_PHOTONS];
Float_t conv_detatrksatecal[MAX_PHOTONS];
Float_t conv_dxy[MAX_PHOTONS];
Float_t conv_dz[MAX_PHOTONS];
Float_t conv_lxy[MAX_PHOTONS];
Float_t conv_lz[MAX_PHOTONS];
Float_t conv_zofprimvtxfromtrks[MAX_PHOTONS];
std::vector<std::vector<unsigned short> >* conv_nHitsBeforeVtx;
Int_t conv_nSharedHits[MAX_PHOTONS];
Int_t conv_validvtx[MAX_PHOTONS];
Int_t conv_MVALikelihood[MAX_PHOTONS];
Float_t conv_chi2[MAX_PHOTONS];
Float_t conv_chi2_probability[MAX_PHOTONS];
Float_t conv_vtx_xErr[MAX_PHOTONS];
Float_t conv_vtx_yErr[MAX_PHOTONS];
Float_t conv_vtx_zErr[MAX_PHOTONS];
Float_t conv_tk1_dz[MAX_PHOTONS];
Float_t conv_tk2_dz[MAX_PHOTONS];
Float_t conv_tk1_dzerr[MAX_PHOTONS];
Float_t conv_tk2_dzerr[MAX_PHOTONS];
Int_t conv_tk1_nh[MAX_PHOTONS];
Int_t conv_tk2_nh[MAX_PHOTONS];
Int_t conv_ch1ch2[MAX_PHOTONS];
Float_t conv_tk1_d0[MAX_PHOTONS];
Float_t conv_tk1_pout[MAX_PHOTONS];
Float_t conv_tk1_pin[MAX_PHOTONS];
Float_t conv_tk2_d0[MAX_PHOTONS];
Float_t conv_tk2_pout[MAX_PHOTONS];
Float_t conv_tk2_pin[MAX_PHOTONS];
