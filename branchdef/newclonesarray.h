  ...
  pho_conv_vtx  = new TClonesArray("TVector3", MAX_CONVERTEDPHOTONS);
  pho_conv_pair_momentum  = new TClonesArray("TVector3", MAX_CONVERTEDPHOTONS);
  pho_conv_refitted_momentum  = new TClonesArray("TVector3", MAX_CONVERTEDPHOTONS);
  pho_conv_vertexcorrected_p4  = new TClonesArray("TLorentzVector", MAX_CONVERTEDPHOTONS);
  conv_p4 = new TClonesArray("TLorentzVector", MAX_GENERATOR);
