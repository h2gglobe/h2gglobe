...
void Branch_pu_n(TTree * tree) { tree->Branch("pu_n", &pu_n, "pu_n/I"); };
   void Branch_pu_zpos		(TTree * tree) { tree->Branch("pu_zpos", "std::vector<std::vector<float> >", &pu_zpos		); }; 
   void Branch_pu_sumpt_lowpt	(TTree * tree) { tree->Branch("pu_sumpt_lowpt", "std::vector<std::vector<float> >", &pu_sumpt_lowpt	); }; 
   void Branch_pu_sumpt_highpt	(TTree * tree) { tree->Branch("pu_sumpt_highpt", "std::vector<std::vector<float> >", &pu_sumpt_highpt	); }; 
   void Branch_pu_ntrks_lowpt	(TTree * tree) { tree->Branch("pu_ntrks_lowpt", "std::vector<std::vector<float> >", &pu_ntrks_lowpt	); }; 
   void Branch_pu_ntrks_highpt  (TTree * tree) { tree->Branch("pu_ntrks_highpt" ,  "std::vector<std::vector<float> >", &pu_ntrks_highpt ); }; 
