...
void Branch_sc_bcseed_phicry(TTree *tree){ tree->Branch("sc_bcseed_phicry",&sc_bcseed_phicry,"sc_bcseed_phicry[sc_n]/F"); };
void Branch_sc_bcseed_iphi(TTree *tree){ tree->Branch("sc_bcseed_iphi",&sc_bcseed_iphi,"sc_bcseed_iphi[sc_n]/I"); };
void Branch_sc_bcseed_right(TTree *tree){ tree->Branch("sc_bcseed_right",&sc_bcseed_right,"sc_bcseed_right[sc_n]/F"); };
void Branch_sc_bcseed_2x5max(TTree *tree){ tree->Branch("sc_bcseed_2x5max",&sc_bcseed_2x5max,"sc_bcseed_2x5max[sc_n]/F"); };
void Branch_sc_bcseed_left(TTree *tree){ tree->Branch("sc_bcseed_left",&sc_bcseed_left,"sc_bcseed_left[sc_n]/F"); };
void Branch_sc_bcseed_etacry(TTree *tree){ tree->Branch("sc_bcseed_etacry",&sc_bcseed_etacry,"sc_bcseed_etacry[sc_n]/F"); };
void Branch_sc_bcseed_ieta(TTree *tree){ tree->Branch("sc_bcseed_ieta",&sc_bcseed_ieta,"sc_bcseed_ieta[sc_n]/I"); };
void Branch_sc_bcseed_s2nd(TTree *tree){ tree->Branch("sc_bcseed_s2nd",&sc_bcseed_s2nd,"sc_bcseed_s2nd[sc_n]/F"); };
void Branch_sc_bcseed_2x5top(TTree *tree){ tree->Branch("sc_bcseed_2x5top",&sc_bcseed_2x5top,"sc_bcseed_2x5top[sc_n]/F"); };
void Branch_sc_bcseed_2x5right(TTree *tree){ tree->Branch("sc_bcseed_2x5right",&sc_bcseed_2x5right,"sc_bcseed_2x5right[sc_n]/F"); };
void Branch_sc_bcseed_bottom(TTree *tree){ tree->Branch("sc_bcseed_bottom",&sc_bcseed_bottom,"sc_bcseed_bottom[sc_n]/F"); };
void Branch_sc_bcseed_sMax(TTree *tree){ tree->Branch("sc_bcseed_sMax",&sc_bcseed_sMax,"sc_bcseed_sMax[sc_n]/F"); };
void Branch_sc_bcseed_top(TTree *tree){ tree->Branch("sc_bcseed_top",&sc_bcseed_top,"sc_bcseed_top[sc_n]/F"); };
void Branch_sc_bcseed_2x5bottom(TTree *tree){ tree->Branch("sc_bcseed_2x5bottom",&sc_bcseed_2x5bottom,"sc_bcseed_2x5bottom[sc_n]/F"); };
void Branch_sc_bcseed_2x5left(TTree *tree){ tree->Branch("sc_bcseed_2x5left",&sc_bcseed_2x5left,"sc_bcseed_2x5left[sc_n]/F"); };
...
void Branch_bc_sipip(TTree * tree) { tree->Branch("bc_sipip",&bc_sipip, "bc_sipip[bc_n]/F");  }; 
void Branch_bc_sieip(TTree * tree) { tree->Branch("bc_sieip",&bc_sieip, "bc_sieip[bc_n]/F");  }; 
