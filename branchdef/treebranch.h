      ...
      outputTree->Branch("ecalhit_type",&loops->ecalhit_type, "ecalhit_type[ecalhit_n]/S"); 
      outputTree->Branch("ecalhit_flag",&loops->ecalhit_flag, "ecalhit_flag[ecalhit_n]/S"); 
...
outputTree->Branch("jet_algo1_p4", "TClonesArray",&loops->jet_algo1_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algo1_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo1_tkind);
   outputTree->Branch("jet_algo1_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo1_calotwind);
...
outputTree->Branch("jet_algo2_p4", "TClonesArray",&loops->jet_algo2_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algo2_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo2_tkind);
   outputTree->Branch("jet_algo2_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo2_calotwind);
...
outputTree->Branch("jet_algo3_p4", "TClonesArray",&loops->jet_algo3_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algo3_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo3_tkind);
   outputTree->Branch("jet_algo3_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algo3_calotwind);
...
outputTree->Branch("jet_algoPF1_p4", "TClonesArray",&loops->jet_algoPF1_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algoPF1_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF1_tkind);
   outputTree->Branch("jet_algoPF1_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF1_calotwind);
...
outputTree->Branch("jet_algoPF2_p4", "TClonesArray",&loops->jet_algoPF2_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algoPF2_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF2_tkind);
   outputTree->Branch("jet_algoPF2_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF2_calotwind);
...
outputTree->Branch("jet_algoPF3_p4", "TClonesArray",&loops->jet_algoPF3_p4, 32000, 0);
   ...
   outputTree->Branch("jet_algoPF3_tkind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF3_tkind);
   outputTree->Branch("jet_algoPF3_calotwind", "std::vector<std::vector<unsigned short> >", &loops->jet_algoPF3_calotwind);
   ...
   outputTree->Branch("l1bits_tec", "std::vector<int>", &loops->l1bits_tec);
      ...
      outputTree->Branch("pho_feta",&loops->pho_feta,"pho_feta[pho_n][5]/F"); 
      outputTree->Branch("pho_crackcorr",&loops->pho_crackcorr,"pho_crackcorr[pho_n]/F"); 
      outputTree->Branch("pho_localcorr",&loops->pho_localcorr,"pho_localcorr[pho_n]/F"); 
      ...
      outputTree->Branch("pho_sipip",&loops->pho_sipip,"pho_sipip[pho_n]/F"); 
      outputTree->Branch("pho_sieip",&loops->pho_sieip,"pho_sieip[pho_n]/F"); 
      outputTree->Branch("pho_zernike20",&loops->pho_zernike20,"pho_zernike20[pho_n]/F"); 
      outputTree->Branch("pho_zernike42",&loops->pho_zernike42,"pho_zernike42[pho_n]/F"); 
      outputTree->Branch("pho_e2nd",&loops->pho_e2nd,"pho_e2nd[pho_n]/F"); 
      outputTree->Branch("pho_e2x5right",&loops->pho_e2x5right,"pho_e2x5right[pho_n]/F"); 
      outputTree->Branch("pho_e2x5left",&loops->pho_e2x5left,"pho_e2x5left[pho_n]/F"); 
      outputTree->Branch("pho_e2x5Top",&loops->pho_e2x5Top,"pho_e2x5Top[pho_n]/F"); 
      outputTree->Branch("pho_e2x5bottom",&loops->pho_e2x5bottom,"pho_e2x5bottom[pho_n]/F"); 
      outputTree->Branch("pho_eright",&loops->pho_eright,"pho_eright[pho_n]/F"); 
      outputTree->Branch("pho_eleft",&loops->pho_eleft,"pho_eleft[pho_n]/F"); 
      outputTree->Branch("pho_etop",&loops->pho_etop,"pho_etop[pho_n]/F"); 
      outputTree->Branch("pho_ebottom",&loops->pho_ebottom,"pho_ebottom[pho_n]/F"); 
      outputTree->Branch("pho_e2overe9",&loops->pho_e2overe9,"pho_e2overe9[pho_n]/F"); 
      outputTree->Branch("pho_seed_severity",&loops->pho_seed_severity,"pho_seed_severity[pho_n]/F"); 
      outputTree->Branch("pho_seed_time",&loops->pho_seed_time,"pho_seed_time[pho_n]/F"); 
      outputTree->Branch("pho_seed_outoftimechi2",&loops->pho_seed_outoftimechi2,"pho_seed_outoftimechi2[pho_n]/F"); 
      outputTree->Branch("pho_seed_chi2",&loops->pho_seed_chi2,"pho_seed_chi2[pho_n]/F"); 
      outputTree->Branch("pho_seed_recoflag",&loops->pho_seed_recoflag,"pho_seed_recoflag[pho_n]/F"); 
...
outputTree->Branch("vtx_vectorp3", "TClonesArray",&loops->vtx_vectorp3, 32000, 0);
   ...
   outputTree->Branch("vtx_tkind", "std::vector<std::vector<unsigned short> >", &loops->vtx_tkind);
   outputTree->Branch("vtx_tkweight", "std::vector<std::vector<float> >", &loops->vtx_tkweight);
...
outputTree->Branch("vtx_std_vectorp3", "TClonesArray",&loops->vtx_std_vectorp3, 32000, 0);
   ...
   outputTree->Branch("vtx_std_tkind", "std::vector<std::vector<unsigned short> >", &loops->vtx_std_tkind);
   outputTree->Branch("vtx_std_tkweight", "std::vector<std::vector<float> >", &loops->vtx_std_tkweight);
