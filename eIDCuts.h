...
Use standard isolation as defined in CMSSW_3_1_X:
Track Isolation: 0.3 cone 
ECAL Isolation: 0.4 cone
HCAL Isolation: 0.4 cone

********************************************************/

float cutdeta[3][10][6] = 
{
	{
