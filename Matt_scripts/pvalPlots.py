...
for i in range(len(files)):
	...
	onepoint.SetPoint(0,124.0,ROOT.RooStats.PValueToSignificance(ggr.Eval(124.0)))
...
Box.Draw()
#mytext
mytext.DrawLatex(0.55,0.22,"#splitline{CMS preliminary}{#sqrt{s} = 7 TeV L = %.1f fb^{-1}}"%float(intlumi))
dp.SetGrid(True)
dp.SetLogy()
