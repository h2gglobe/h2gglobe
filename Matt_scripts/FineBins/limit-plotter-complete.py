...
OBSmasses = numpy.arange(120,130.05,0.1)
EXPmasses = numpy.arange(120,130.05,0.1)
...
parser.add_option("-a","--additional",dest="addFile")
...
if options.addFile:
  f = ROOT.TFile(options.addFile)
  graphMed = f.Get('median')
  graph68 = f.Get('median68')
  graph95 = f.Get('median95')
