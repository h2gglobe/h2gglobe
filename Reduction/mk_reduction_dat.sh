...
rm data/*.dat
./PhotonAnalysis_scripts/mk_reduction_dat.py /castor/cern.ch/user/c/cmshgg/reduced/h2gglobe_V11_04_05_reduction_18Feb/Data ${storedir}/Data data.txt
...
./PhotonAnalysis_scripts/mk_reduction_dat.py /castor/cern.ch/user/c/cmshgg/reduced/h2gglobe_V11_04_05_reduction_18Feb/MC_Sig_Fall11_S6 ${storedir}/MC_Sig_Fall11_S6 mc_sig_fall11_s6.txt
