...
void Normalization_8TeV::Init7TeV(){
    ...
    XSectionMap_wzh[90]=2.4997;
    XSectionMap_wzh[95]=2.1268;
    XSectionMap_wzh[100]=1.8173;
    XSectionMap_wzh[105]=1.5629;
    XSectionMap_wzh[110]=1.3475;
    XSectionMap_wzh[110.5]=1.3278;
    XSectionMap_wzh[111]=1.3084;
    XSectionMap_wzh[111.5]=1.2893;
    XSectionMap_wzh[112]=1.2706;
    XSectionMap_wzh[112.5]=1.2522;
    XSectionMap_wzh[113]=1.2343;
    XSectionMap_wzh[113.5]=1.2165;
    XSectionMap_wzh[114]=1.1991;
    XSectionMap_wzh[114.5]=1.1821;
    XSectionMap_wzh[115]=1.1653;
    XSectionMap_wzh[115.5]=1.1491;
    XSectionMap_wzh[116]=1.1331;
    XSectionMap_wzh[116.5]=1.1175;
    XSectionMap_wzh[117]=1.1022;
    XSectionMap_wzh[117.5]=1.0872;
    XSectionMap_wzh[118]=1.0724;
    XSectionMap_wzh[118.5]=1.0579;
    XSectionMap_wzh[119]=1.0437;
    XSectionMap_wzh[119.5]=1.0296;
    XSectionMap_wzh[120]=1.0159;
    XSectionMap_wzh[120.5]=1.0023;
    XSectionMap_wzh[121]=0.9889;
    XSectionMap_wzh[121.5]=0.9756;
    XSectionMap_wzh[122]=0.9626;
    XSectionMap_wzh[122.5]=0.9499;
    XSectionMap_wzh[123]=0.9372;
    XSectionMap_wzh[123.5]=0.9248;
    XSectionMap_wzh[124]=0.9126;
    XSectionMap_wzh[124.5]=0.9005;
    XSectionMap_wzh[125]=0.8887;
    XSectionMap_wzh[125.5]=0.8769;
    XSectionMap_wzh[126]=0.8653;
    XSectionMap_wzh[126.5]=0.8539;
    XSectionMap_wzh[127]=0.8427;
    XSectionMap_wzh[127.5]=0.8316;
    XSectionMap_wzh[128]=0.8207;
    XSectionMap_wzh[128.5]=0.8099;
    XSectionMap_wzh[129]=0.7993;
    XSectionMap_wzh[129.5]=0.7888;
    XSectionMap_wzh[130]=0.7786;
    XSectionMap_wzh[130.5]=0.7685;
    XSectionMap_wzh[131]=0.7586;
    XSectionMap_wzh[131.5]=0.7488;
    XSectionMap_wzh[132]=0.7391;
    XSectionMap_wzh[132.5]=0.7296;
    XSectionMap_wzh[133]=0.7203;
    XSectionMap_wzh[133.5]=0.7111;
    XSectionMap_wzh[134]=0.702;
    XSectionMap_wzh[134.5]=0.6931;
    XSectionMap_wzh[135]=0.6843;
    XSectionMap_wzh[135.5]=0.6756;
    XSectionMap_wzh[136]=0.667;
    XSectionMap_wzh[136.5]=0.6585;
    XSectionMap_wzh[137]=0.6503;
    XSectionMap_wzh[137.5]=0.642;
    XSectionMap_wzh[138]=0.6339;
    XSectionMap_wzh[138.5]=0.626;
    XSectionMap_wzh[139]=0.6182;
    XSectionMap_wzh[139.5]=0.6105;
    XSectionMap_wzh[140]=0.6029;
    XSectionMap_wzh[141]=0.5882;
    XSectionMap_wzh[142]=0.574;
    XSectionMap_wzh[143]=0.5602;
    XSectionMap_wzh[144]=0.5467;
    XSectionMap_wzh[145]=0.5336;
    XSectionMap_wzh[146]=0.5205;
    XSectionMap_wzh[147]=0.5078;
    XSectionMap_wzh[148]=0.4953;
    XSectionMap_wzh[149]=0.4832;
    XSectionMap_wzh[150]=0.4714;
    XSectionMap_wzh[151]=0.4602;
    XSectionMap_wzh[152]=0.4492;
    XSectionMap_wzh[153]=0.4384;
    XSectionMap_wzh[154]=0.4277;
    XSectionMap_wzh[155]=0.4171;
    XSectionMap_wzh[156]=0.4053;
    XSectionMap_wzh[157]=0.3938;
    XSectionMap_wzh[158]=0.3827;
    XSectionMap_wzh[159]=0.3722;
    XSectionMap_wzh[160]=0.3625;
    XSectionMap_wzh[162]=0.3498;
    XSectionMap_wzh[164]=0.3392;
    XSectionMap_wzh[166]=0.3271;
    XSectionMap_wzh[168]=0.313;
    XSectionMap_wzh[170]=0.2989;
    XSectionMap_wzh[172]=0.2862;
    XSectionMap_wzh[174]=0.2742;
    XSectionMap_wzh[176]=0.26262;
    XSectionMap_wzh[178]=0.2516;
    XSectionMap_wzh[180]=0.24127;
    XSectionMap_wzh[182]=0.23239;
    XSectionMap_wzh[184]=0.22416;
    XSectionMap_wzh[186]=0.21581;
    XSectionMap_wzh[188]=0.20718;
    XSectionMap_wzh[190]=0.19896;
    XSectionMap_wzh[192]=0.19139;
    XSectionMap_wzh[194]=0.18426;
    XSectionMap_wzh[196]=0.17733;
    XSectionMap_wzh[198]=0.1706;
    XSectionMap_wzh[200]=0.16416;
    XSectionMap_wzh[202]=0.15804;
    XSectionMap_wzh[204]=0.15221;
    XSectionMap_wzh[206]=0.14665;
    XSectionMap_wzh[208]=0.14133;
    XSectionMap_wzh[210]=0.13625;
    XSectionMap_wzh[212]=0.13135;
    XSectionMap_wzh[214]=0.12666;
    XSectionMap_wzh[216]=0.12218;
    XSectionMap_wzh[218]=0.11788;
    XSectionMap_wzh[220]=0.11377;
    XSectionMap_wzh[222]=0.10984;
    XSectionMap_wzh[224]=0.10607;
    XSectionMap_wzh[226]=0.10246;
    XSectionMap_wzh[228]=0.09898;
    XSectionMap_wzh[230]=0.09566;
    XSectionMap_wzh[232]=0.09244;
    XSectionMap_wzh[234]=0.08934;
    XSectionMap_wzh[236]=0.08635;
    XSectionMap_wzh[238]=0.0835;
    XSectionMap_wzh[240]=0.08074;
    XSectionMap_wzh[242]=0.07809;
    XSectionMap_wzh[244]=0.07555;
    XSectionMap_wzh[246]=0.0731;
    XSectionMap_wzh[248]=0.07075;
    XSectionMap_wzh[250]=0.06848;
