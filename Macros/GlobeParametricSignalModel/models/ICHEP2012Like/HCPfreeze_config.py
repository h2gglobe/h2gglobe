...
if year == 2011:
    ...
    inputFile = "/afs/cern.ch/work/m/mkenzie/private/h2g/latest_workspaces/CMS-HGG_massfacmva_hcpFreeze_v6.root"
    outputFile = "SigMod_hcpFreeze_v6.root"
    # outputFile = "ubersignalmodel-%d.root" % year
...
globalConfig = {
    ...
    "minMassHypothesis": 120,
    "maxMassHypothesis": 130,
...
if year == 2011:
    ...
    tmp = {
        ...
        'cat8': { 'ggh': 2, 'vbf': 2, 'wzh': 3, 'tth': 3 },
        }

    tmp_wrong = {
		    'cat0': { 'ggh': 2, 'vbf': 2, 'wzh': 2, 'tth': 1 },
		    'cat1': { 'ggh': 2, 'vbf': 2, 'wzh': 2, 'tth': 2 },
        'cat2': { 'ggh': 2, 'vbf': 2, 'wzh': 2, 'tth': 2 },
        'cat3': { 'ggh': 2, 'vbf': 2, 'wzh': 2, 'tth': 2 },

        'cat4': { 'ggh': 2, 'vbf': 2, 'wzh': 1, 'tth': 1 },
        'cat5': { 'ggh': 2, 'vbf': 2, 'wzh': 1, 'tth': 1 },

        'cat6': { 'ggh': 1, 'vbf': 1, 'wzh': 1, 'tth': 1 },
        'cat7': { 'ggh': 1, 'vbf': 1, 'wzh': 1, 'tth': 1 },
...
smearings = {
    ...
    '8TeV': {catNamePrefix + '0': 0.010337,
             catNamePrefix + '1': 0.009164,
             catNamePrefix + '2': 0.012829,
             catNamePrefix + '3': 0.010269,
             catNamePrefix + '4': 0.010452,
             catNamePrefix + '5': 0.010187,
             catNamePrefix + '6': 0.010331,
             catNamePrefix + '7': 0.011474,
             catNamePrefix + '8': 0.009424,
             },
          }
