...
for mode in ['data','bkg','ggh','vbf','wzh','tth']:
  ...
  file.write('\n')
  file.write('if ( %s/bin/RunFullMvaAnalysis -i %s -o %s/files/CMS-HGG_fmt_%s.root --skipRebin --histosFromTrees --useDat %s/%s -v -D --histFromTreeMode %s ); \n'%(dir,infile,dir,mode,dir,datfile,mode))
