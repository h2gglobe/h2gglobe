...
combine cms-hgg-datacard_parBKG.txt -M ProfileLikelihood -D data_mass -m $2 -s -1 -S 1 --generateBinnedWorkaround --tries 1  --maxTries 200 --rMin=0. --rMax=35 -H ProfileLikelihood --hintStatOnly | tee mH$2.$$.log
