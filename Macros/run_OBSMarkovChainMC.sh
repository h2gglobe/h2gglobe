...
combine cms-hgg-datacard_parBKG.txt -M MarkovChainMC -D data_mass -m $2 -s -1 -S 1 --generateBinnedWorkaround  -H ProfileLikelihood -n OBSERVED --rMin=0 --rMax=40 --truncatedMeanFraction 0.05  --iteration 70000 --tries 200 --hintStatOnly | tee mH$2.Markov.$$.log
