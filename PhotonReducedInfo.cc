...
PhotonReducedInfo::PhotonReducedInfo(const TVector3 & caloPosition, float energy, float corrEnergy, int iDet, float r9, int ipho, bool passId, float corrEnergyErr) :
	caloPosition_(caloPosition), rawCaloPosition_(caloPosition), energy_(energy),
	corrEnergy_(corrEnergy), iDet_(iDet), iPho_(ipho), r9_(r9), passId_(passId), corrEnergyErr_(corrEnergyErr),sphericalPhoton_(false),
