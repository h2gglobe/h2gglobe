...
PhotonReducedInfo::PhotonReducedInfo(const TVector3 & caloPosition, float energy,int iDet, float r9) :
  caloPosition_(caloPosition), energy_(energy), iDet_(iDet), r9_(r9)
{
}
