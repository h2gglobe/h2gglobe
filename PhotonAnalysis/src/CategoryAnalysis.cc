				...
				BaseGenLevelSmearer *genSys, BaseSmearer *phoSys, BaseDiPhotonSmearer * diPhoSys) 
{
	...
	if (!VBFevent) {
	  ...
	  if( mass>=massMin && mass<=massMax) {
	    ...
	    if (passCiC && !passMVApresel) {
	      l.FillHist2D("pt_vs_bdtout_failpresel",selectioncategory,diphobdt_output,ptHiggs,evweight);
	      l.FillHist("bdtout_failpresel",selectioncategory,diphobdt_output,evweight);
	    }

	    float rhofac=0.17;

	    float lead_hoe        = l.pho_hoe[diphoton_index.first];
	    float lead_sieie      = l.pho_sieie[diphoton_index.first];                                                          
	    float lead_ecaliso = l.pho_ecalsumetconedr03[diphoton_index.first] - 0.012*lead_p4.Et();                              
	    float lead_hcaliso = l.pho_hcalsumetconedr03[diphoton_index.first] - 0.005*lead_p4.Et(); 
	    float lead_trkiso  = l.pho_trksumpthollowconedr03[diphoton_index.first] - 0.002*lead_p4.Et();                          
	    float lead_hcalecal   = (l.pho_ecalsumetconedr03[diphoton_index.first]+l.pho_hcalsumetconedr03[diphoton_index.first]-l.rho*rhofac);
	    float lead_abstrkiso  = (*l.pho_tkiso_recvtx_030_002_0000_10_01)[diphoton_index.first][l.dipho_vtxind[diphoton_id]];                
	    float lead_trkiso_hollow03 = l.pho_trksumpthollowconedr03[diphoton_index.first]; 

	    float sublead_hoe        = l.pho_hoe[diphoton_index.second];
	    float sublead_sieie      = l.pho_sieie[diphoton_index.second];                                                          
	    float sublead_ecaliso = l.pho_ecalsumetconedr03[diphoton_index.second] - 0.012*sublead_p4.Et();                              
	    float sublead_hcaliso = l.pho_hcalsumetconedr03[diphoton_index.second] - 0.005*sublead_p4.Et(); 
	    float sublead_trkiso  = l.pho_trksumpthollowconedr03[diphoton_index.second] - 0.002*sublead_p4.Et();                          
	    float sublead_hcalecal   = (l.pho_ecalsumetconedr03[diphoton_index.second]+l.pho_hcalsumetconedr03[diphoton_index.second]-l.rho*rhofac);
	    float sublead_abstrkiso  = (*l.pho_tkiso_recvtx_030_002_0000_10_01)[diphoton_index.second][l.dipho_vtxind[diphoton_id]];                
	    float sublead_trkiso_hollow03 = l.pho_trksumpthollowconedr03[diphoton_index.second];  

	    if (passCiC) {
	      if (passMVApresel) {
		if (diphobdt_output>0.05) {
		  l.FillHist("lead_hoe",selectioncategory,lead_hoe,evweight);
		  l.FillHist("lead_sieie",selectioncategory,lead_sieie,evweight);
		  l.FillHist("lead_ecaliso",selectioncategory,lead_ecaliso,evweight);
		  l.FillHist("lead_hcaliso",selectioncategory,lead_hcaliso,evweight);
		  l.FillHist("lead_trkiso",selectioncategory,lead_trkiso,evweight);
		  l.FillHist("lead_hcalecal",selectioncategory,lead_hcalecal,evweight);
		  l.FillHist("lead_abstrkiso",selectioncategory,lead_abstrkiso,evweight);
		  l.FillHist("lead_trkiso_hollow03",selectioncategory,lead_trkiso_hollow03,evweight);
		  l.FillHist("lead_phoid_mvaout",selectioncategory,phoid_mvaout_lead,evweight);
		  l.FillHist("lead_pt",selectioncategory,lead_p4.Pt(),evweight);
		  l.FillHist("lead_eta",selectioncategory,lead_p4.Eta(),evweight);

		  l.FillHist("sublead_hoe",selectioncategory,sublead_hoe,evweight);
		  l.FillHist("sublead_sieie",selectioncategory,sublead_sieie,evweight);
		  l.FillHist("sublead_ecaliso",selectioncategory,sublead_ecaliso,evweight);
		  l.FillHist("sublead_hcaliso",selectioncategory,sublead_hcaliso,evweight);
		  l.FillHist("sublead_trkiso",selectioncategory,sublead_trkiso,evweight);
		  l.FillHist("sublead_hcalecal",selectioncategory,sublead_hcalecal,evweight);
		  l.FillHist("sublead_abstrkiso",selectioncategory,sublead_abstrkiso,evweight);
		  l.FillHist("sublead_trkiso_hollow03",selectioncategory,sublead_trkiso_hollow03,evweight);
		  l.FillHist("sublead_phoid_mvaout",selectioncategory,phoid_mvaout_sublead,evweight);
		  l.FillHist("sublead_pt",selectioncategory,sublead_p4.Pt(),evweight);
		  l.FillHist("sublead_eta",selectioncategory,sublead_p4.Eta(),evweight);
		}
	      } else {
		if (diphobdt_output>0.05) {
		  l.FillHist("lead_hoe_failpresel_bdtoutgt05",selectioncategory,lead_hoe,evweight);
		  l.FillHist("lead_sieie_failpresel_bdtoutgt05",selectioncategory,lead_sieie,evweight);
		  l.FillHist("lead_ecaliso_failpresel_bdtoutgt05",selectioncategory,lead_ecaliso,evweight);
		  l.FillHist("lead_hcaliso_failpresel_bdtoutgt05",selectioncategory,lead_hcaliso,evweight);
		  l.FillHist("lead_trkiso_failpresel_bdtoutgt05",selectioncategory,lead_trkiso,evweight);
		  l.FillHist("lead_hcalecal_failpresel_bdtoutgt05",selectioncategory,lead_hcalecal,evweight);
		  l.FillHist("lead_abstrkiso_failpresel_bdtoutgt05",selectioncategory,lead_abstrkiso,evweight);
		  l.FillHist("lead_trkiso_hollow03_failpresel_bdtoutgt05",selectioncategory,lead_trkiso_hollow03,evweight);
		  l.FillHist("lead_phoid_mvaout_failpresel_bdtoutgt05",selectioncategory,phoid_mvaout_lead,evweight);
		  l.FillHist("lead_pt_failpresel_bdtoutgt05",selectioncategory,lead_p4.Pt(),evweight);
		  l.FillHist("lead_eta_failpresel_bdtoutgt05",selectioncategory,lead_p4.Eta(),evweight);

		  l.FillHist("sublead_hoe_failpresel_bdtoutgt05",selectioncategory,sublead_hoe,evweight);
		  l.FillHist("sublead_sieie_failpresel_bdtoutgt05",selectioncategory,sublead_sieie,evweight);
		  l.FillHist("sublead_ecaliso_failpresel_bdtoutgt05",selectioncategory,sublead_ecaliso,evweight);
		  l.FillHist("sublead_hcaliso_failpresel_bdtoutgt05",selectioncategory,sublead_hcaliso,evweight);
		  l.FillHist("sublead_trkiso_failpresel_bdtoutgt05",selectioncategory,sublead_trkiso,evweight);
		  l.FillHist("sublead_hcalecal_failpresel_bdtoutgt05",selectioncategory,sublead_hcalecal,evweight);
		  l.FillHist("sublead_abstrkiso_failpresel_bdtoutgt05",selectioncategory,sublead_abstrkiso,evweight);
		  l.FillHist("sublead_trkiso_hollow03_failpresel_bdtoutgt05",selectioncategory,sublead_trkiso_hollow03,evweight);
		  l.FillHist("sublead_phoid_mvaout_failpresel_bdtoutgt05",selectioncategory,phoid_mvaout_sublead,evweight);
		  l.FillHist("sublead_pt_failpresel_bdtoutgt05",selectioncategory,sublead_p4.Pt(),evweight);
		  l.FillHist("sublead_eta_failpresel_bdtoutgt05",selectioncategory,sublead_p4.Eta(),evweight);
		} else {
		  l.FillHist("lead_hoe_failpresel_bdtoutlt05",selectioncategory,lead_hoe,evweight);
		  l.FillHist("lead_sieie_failpresel_bdtoutlt05",selectioncategory,lead_sieie,evweight);
		  l.FillHist("lead_ecaliso_failpresel_bdtoutlt05",selectioncategory,lead_ecaliso,evweight);
		  l.FillHist("lead_hcaliso_failpresel_bdtoutlt05",selectioncategory,lead_hcaliso,evweight);
		  l.FillHist("lead_trkiso_failpresel_bdtoutlt05",selectioncategory,lead_trkiso,evweight);
		  l.FillHist("lead_hcalecal_failpresel_bdtoutlt05",selectioncategory,lead_hcalecal,evweight);
		  l.FillHist("lead_abstrkiso_failpresel_bdtoutlt05",selectioncategory,lead_abstrkiso,evweight);
		  l.FillHist("lead_trkiso_hollow03_failpresel_bdtoutlt05",selectioncategory,lead_trkiso_hollow03,evweight);
		  l.FillHist("lead_phoid_mvaout_failpresel_bdtoutlt05",selectioncategory,phoid_mvaout_lead,evweight);
		  l.FillHist("lead_pt_failpresel_bdtoutlt05",selectioncategory,lead_p4.Pt(),evweight);
		  l.FillHist("lead_eta_failpresel_bdtoutlt05",selectioncategory,lead_p4.Eta(),evweight);

		  l.FillHist("sublead_hoe_failpresel_bdtoutlt05",selectioncategory,sublead_hoe,evweight);
		  l.FillHist("sublead_sieie_failpresel_bdtoutlt05",selectioncategory,sublead_sieie,evweight);
		  l.FillHist("sublead_ecaliso_failpresel_bdtoutlt05",selectioncategory,sublead_ecaliso,evweight);
		  l.FillHist("sublead_hcaliso_failpresel_bdtoutlt05",selectioncategory,sublead_hcaliso,evweight);
		  l.FillHist("sublead_trkiso_failpresel_bdtoutlt05",selectioncategory,sublead_trkiso,evweight);
		  l.FillHist("sublead_hcalecal_failpresel_bdtoutlt05",selectioncategory,sublead_hcalecal,evweight);
		  l.FillHist("sublead_abstrkiso_failpresel_bdtoutlt05",selectioncategory,sublead_abstrkiso,evweight);
		  l.FillHist("sublead_trkiso_hollow03_failpresel_bdtoutlt05",selectioncategory,sublead_trkiso_hollow03,evweight);
		  l.FillHist("sublead_phoid_mvaout_failpresel_bdtoutlt05",selectioncategory,phoid_mvaout_sublead,evweight);
		  l.FillHist("sublead_pt_failpresel_bdtoutlt05",selectioncategory,sublead_p4.Pt(),evweight);
		  l.FillHist("sublead_eta_failpresel_bdtoutlt05",selectioncategory,sublead_p4.Eta(),evweight);
		}
	      }
	    }
