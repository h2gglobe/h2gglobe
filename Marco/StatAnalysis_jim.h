 ...
 */
 ...
 void HggBookOptree();
 void SetOutputNtupleVariables(int jentry, int itype, int leadind, int subleadind, int vtxind, float mass, TLorentzVector *leadp4, TLorentzVector *subleadp4, float evweight, float pileupWeight, TLorentzVector * jet1=0, TLorentzVector * jet2=0);
